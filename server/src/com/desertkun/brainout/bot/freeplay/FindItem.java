...
public class FindItem extends Task
{
    private final ItemPredicate predicate;
    private final EnemyNoticedCallback enemyNoticedCallback;
    private final ItemTakenCallback itemTakenCallback;
    ...
    {
        void found(ConsumableRecord record);
    }

    public FindItem(TaskStack stack, ItemPredicate predicate,
        EnemyNoticedCallback enemyNoticedCallback,
        ItemTakenCallback itemTakenCallback)
    {
        super(stack);
    ...
    protected void update(float dt)
    {
        ...
        popMeAndPushTask(new TakeItem(getStack(),
            best.activeData, best.record, best.amount, enemyNoticedCallback, itemTakenCallback));
    }
