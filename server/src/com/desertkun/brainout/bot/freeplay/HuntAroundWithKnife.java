...
public class HuntAroundWithKnife extends Task
{
    ...
    public HuntAroundWithKnife(TaskStack stack)
    {
        super(stack);
    ...
    protected void update(float dt)
    {
        ...
        if (enemy != null)
        {
            pushTask(new TaskFollowAndKnifeTarget(getStack(), enemy,
                new RandomValue(0.1f, 0.1f), new RandomValue(0.1f, 0.1f)));
            return;
        }
    ...
    {
        pushTask(new TaskFollowAndKnifeTarget(getStack(), shooter,
            new RandomValue(0.1f, 0.1f), new RandomValue(0.1f, 0.1f)));
    }
