...
import com.desertkun.brainout.content.components.ServerFreeplayExitDoorComponent;
...
@Reflect("ServerExitDoorComponent")
@ReflectAlias("data.components.ServerExitDoorComponentData")
public class ServerExitDoorComponentData extends Component<ServerFreeplayExitDoorComponent>
{
    public ServerExitDoorComponentData(ComponentObject componentObject,
                                       ServerFreeplayExitDoorComponent contentComponent)
    {
    ...
    private void enter(Client client, PlayerData playerData)
    {
        ...
        progress.startCancellable(5.0f, () ->
        {
