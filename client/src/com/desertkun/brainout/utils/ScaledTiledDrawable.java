 ...
 * @author Nathan Sweet */
public class ScaledTiledDrawable extends TextureRegionDrawable {
	...
	{
		draw(batch, x, y, width, height, 1.0f);
	}

	public void draw (Batch batch, float x, float y, float width, float height, float scale) {
	...
	public ScaledTiledDrawable tint (Color tint) {
		ScaledTiledDrawable drawable = new ScaledTiledDrawable(this);
