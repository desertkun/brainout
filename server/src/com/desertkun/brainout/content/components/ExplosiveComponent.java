...
@Reflect("content.components.ExplosiveComponent")
public class ExplosiveComponent extends ContentComponent
{
    ...
    @Override
    public ExplosiveComponentData getComponent(ComponentObject componentObject)
    {
        return new ExplosiveComponentData(componentObject, this);
    }
