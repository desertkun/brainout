...
public class BadgeUnlockTooltip
{
    public static class UnlockTooltipCreator implements Tooltip.TooltipCreator
    {
        ...
        public Actor get()
        {
            ...
            if (userProfile != null && !item.hasItem(userProfile) && item.isLocked(userProfile))
            {
            ...
            if (lockItem == null || !lockItem.isValid())
            {
                Label lockedText = new Label(
                    lockItem != null && lockItem.isUnlockTitleValid() ?
            ...
            if (addBottomLine || forceBottomLine())
            {
