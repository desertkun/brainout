...
public class ClientNormalRealization extends ClientGameRealization<GameModeNormal>
{
    public ClientNormalRealization(GameModeNormal gameMode)
    {
        super(gameMode);
    }
        ...
        if (stats != null)
        {
            ...
            if (game != null)
            {
                ...
                for (Team team : game.getTeams())
                {
                    ...
                    statContainer.add(new Image(BrainOutClient.getRegion("icon-tickets"))).padRight(8);
                    ...
                    ProgressBar progress = new ProgressBar(0, getGameMode().getInitialPoints(), 1, false,
