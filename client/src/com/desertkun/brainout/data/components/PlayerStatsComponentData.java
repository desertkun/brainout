...
import com.desertkun.brainout.content.components.PlayerStatsComponent;
...
@Reflect("PlayerStatsComponent")
@ReflectAlias("data.components.PlayerStatsComponentData")
public class PlayerStatsComponentData extends ActiveStatsComponentData<PlayerStatsComponent>
{
    ...
    public PlayerStatsComponentData(PlayerData playerData, PlayerStatsComponent contentComponent)
    {
            ...
            if (ps instanceof PlayStateGame)
            {
                if (playerData != game.getPlayerData())
                {
                    ...
                    boolean isEnemies = gameMode.isEnemies(playerData.getTeam(), game.getTeam()) ||
                            ((ClientRealization) gameMode.getRealization()).isEnemies(CC.getRemoteClients().get(
                                playerData.getOwnerId()), CC.getMyRemoteClient());
    ...
    private void setEnemy(boolean enemy)
    {
        String icon = enemy ? "player-icon-enemy" : "player-icon-friend";
