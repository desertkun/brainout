...
public class MoveObjectsMsg implements ModeMessage
{
    public String d;
    public int[] o;
    public int x, y;

    public MoveObjectsMsg() {}
    public MoveObjectsMsg(String dimension, ObjectSet<ActiveData> objects, int x, int y)
    {
        this.d = dimension;
